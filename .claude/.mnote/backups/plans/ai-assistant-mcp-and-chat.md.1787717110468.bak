...
`append_to_note`, and `autogit_rollback` — **no delete, no move, no create_folder**. Folders
...
Each turn writes a `trace.jsonl` (prompt / model_call / tool_call / tool_result / done) next
