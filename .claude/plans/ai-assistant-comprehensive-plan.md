...
!\[0ad1a393-253f-17a5-e7f4-840da5636e7c.st chelle ashley and shane-654.jpg\](assets/0ad1a393-253f-17a5-e7f4-840da5636e7c.st chelle ashley and shane-654.jpg)

![0d48b8e3-9615-9928-60dc-c754b435e062.st_chelle_ashley_and_shane-378.jpg](assets/0d48b8e3-9615-9928-60dc-c754b435e062.st_chelle_ashley_and_shane-378.jpg)

![1a726755-02f7-0e0d-9670-f78d4d92402e.st_chelle_ashley_and_shane-389.jpg](assets/1a726755-02f7-0e0d-9670-f78d4d92402e.st_chelle_ashley_and_shane-389.jpg)

**Read this before touching the feature again.** 
...
```
The old plan describes a markdown_mcp
crate wr
```

![4c504f76-70b8-cb50-ba51-ee739c624439.5m7a3231.jpg](assets/4c504f76-70b8-cb50-ba51-ee739c624439.5m7a3231.jpg)

itten from scratch and a Vue-based chat panel — neither exists. What exists instead

![1.jpg](assets/1.jpg)

[Markdown\_Cheat\_Sheet.pdf](assets/Markdown_Cheat_Sheet.pdf)

![assets/maos_(dark)_Screenshot_2026-08-27_at_9.54.36_AM.png](assets/maos_(dark)_Screenshot_2026-08-27_at_9.54.36_AM.png)

is documented below.dfdg

![image.png](assets/image_(3).png)
...
![mnote-macos-redesign.jpg](assets/mnote-macos-redesign.jpg)

![mnote-macos-redesign-dark.jpg](assets/mnote-macos-redesign-dark.jpg)
...
- [ ] Converge vendored `solomd-mcp`'s tools onto `markdown_vault::tools::call`, delete its
  ...
  ```
- [ ] Windows parity: `VaultStore.cs`, a `ReadDirectoryChangesW` watcher, autosave, a
  ```
...
outline logic.
- `tools.rs` is the single dispatch point (`call(vault, name, input) -> Result<Value, String>`) both the MCP server and the agent loop use, so the tool contract cannot drift  
...
![imageaa.png](assets/imageaa.png)
...
**FFI** (`markdown_core/src/agent_ffi.rs`, 5 tests): `md_agent_open/close/send_start/ poll_event`. Deliberately no callback from Rust into Swift — `send_start` spawns a  
...
4. **Thinking is received but never shown.** `ChatViewModel.apply()` has `case .thinking:  break // not shown; kept internal for now` — the assistant's reasoning summary is decoded  
